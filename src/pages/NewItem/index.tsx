...
const NewItem = () => {
  ...
  return (
    <MainLayout>
      <div className="max-w-[1200px] mx-auto px-4 lg:px-6 mt-12 pb-16">
        <div className="grid lg:grid-cols-4 gap-10">
          {/* ================= LEFT CONTENT ================= */}
          <div className="lg:col-span-3 flex flex-col gap-8 text-white">
            {/* Image */}
            <div className="w-full h-[250px] sm:h-[350px] lg:h-[450px] rounded-2xl overflow-hidden shadow-lg">
              <img
            ...
            {/* Title & Content */}
            <div className="bg-[#1a0f2a] p-6 sm:p-8 rounded-2xl shadow-md">
          ...
          {/* ================= RIGHT SIDEBAR ================= */}
          <div className="lg:col-span-1 flex flex-col gap-6 text-white">
